...
- **Around seventy-five effects.** Blood drips, lightning, fire, candlelit
...
| [![Night city](docs/assets/demos/cyberpunk.jpg)](https://paperclipmonkey.github.io/facade-mapper/?demo=cyberpunk) | |
| **[Night city →](https://paperclipmonkey.github.io/facade-mapper/?demo=cyberpunk)** Neon tube round every opening, a Japanese sign on the chimney, a holographic advert over the brickwork, code falling in the windows and rain through the lot. | |
...
wheel going off, the power failing. Perseid night gets a single one, because
under a shower the event worth a keypress is one fireball rather than three.
